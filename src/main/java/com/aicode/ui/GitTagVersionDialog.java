...
public final class GitTagVersionDialog extends DialogWrapper {
    ...
    public GitTagVersionDialog(@NotNull Project project, @NotNull VersionCandidates candidates) {
        ...
        majorButton = new JBRadioButton(candidates.major().toTag() + "   Major version");
        minorButton = new JBRadioButton(candidates.minor().toTag() + "   Minor version");
        patchButton = new JBRadioButton(candidates.patch().toTag() + "   Patch version", true);
        ...
        setTitle("Select Git Tag Version");
        setOKButtonText("Release");
        init();
    }
